...
var welcomeContentId = 'welcome-tab-content'
var aboutContentId = 'about-tab-content'
var chaptersContentId = 'chapters-tab-content'
var eventsContentId = 'events-tab-content'
var contactContentId = 'contact-tab-content'
...
function tabClick(event) {
	...
	$($(this).attr('href')).show()
	loadTab(event.target.id)
}

function loadTab(tabId) {
	if (tabId == 'outlier_hosts') {
	  loadOutlierHostsTab()
	} else if (tabId == 'version_o_matic') {
	  loadVersionOMaticTab()
	} else if (tabId == 'maestro_alerts') {
	  loadMaestroAlertsTab()
	} else if (tabId == 'release_tracker') {
	  loadReleaseTrackerTab()
	} else if (tabId == 'on_call') {
	  loadOnCallTab()
	} else if (tabId == 'health_overview') {
	  loadHealthOverviewTab()
	} else {
	  loadQueuesTab()
	}
}
